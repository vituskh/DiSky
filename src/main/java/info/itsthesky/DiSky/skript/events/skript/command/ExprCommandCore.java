...
@Name("Command Core")
@Description("Get the core of a discord command event")
@Since("1.3")
public class ExprCommandCore extends SimpleExpression<String> {
    ...
    @Nullable
    @Override
    protected String[] get(Event e) { return new String[]{commandCore}; }
    @Override
